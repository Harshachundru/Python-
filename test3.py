...
if(average_grade >=6.5):
    if(attendance >= 0.8):
        print("The candidate was approved")
    else:
        print("The candidate was failed  due to low attendence")
elif(attendance >= 0.8):
    print("The candidate was failed due to low grade")
else:
    print("The candidate was failed due to low grades and low attendence") 
